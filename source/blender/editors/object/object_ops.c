...
void ED_operatortypes_object(void)
{
	...
	//custom shit here
	WM_operatortype_append(OBJECT_OT_layer_page);
	WM_operatortype_append(OBJECT_OT_move_to_layer_set);
...
void ED_keymap_object(wmKeyConfig *keyconf)
{
	...
	WM_keymap_add_item(keymap, "OBJECT_OT_move_to_layer_set", MKEY, KM_PRESS, 0, 0);
