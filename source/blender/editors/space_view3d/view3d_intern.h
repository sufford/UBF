...
void VIEW3D_OT_layer_add(struct wmOperatorType *ot);
void VIEW3D_OT_layer_remove(struct wmOperatorType *ot);
bool view3d_layers_visible(Scene *scene, unsigned int lay_mask);
...
bool view3d_base_visible(struct Scene *scene, struct View3D *v3d, struct Base *base);
