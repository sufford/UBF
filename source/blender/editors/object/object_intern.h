...
void OBJECT_OT_layer_page(struct wmOperatorType *ot);          /* ADD THIS */
void OBJECT_OT_move_to_layer_set(struct wmOperatorType *ot);   /* ADD THIS */
void ui_item_move_to_layer_ui(struct uiLayout *layout, struct bContext *C);  /* ADD THIS */
