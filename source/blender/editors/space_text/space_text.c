...
static void text_operatortypes(void)
{
	...
	WM_operatortype_append(TEXT_OT_run_kxscript);
...
static void text_keymap(struct wmKeyConfig *keyconf)
{
	...
	WM_keymap_add_item(keymap, "TEXT_OT_run_kxscript", PKEY, KM_PRESS, KM_ALT | KM_SHIFT, 0);  // Alt+Shift+P for KXScript
