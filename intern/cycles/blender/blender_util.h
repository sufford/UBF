...
/* Version that works with BL::Array types */
template<int N>
static inline uint get_layer(const BL::Array<bool, N>& array)
{
    uint layer = 0;
...
static inline uint get_layer(const BL::Array<bool, N1>& array,
                             const BL::Array<bool, N2>& local_array,
                             bool is_light = false, uint scene_layers = ~0u)
{
    uint layer = 0;
    uint local_offset = 20;
