...
static uiBlock *wm_block_create_splash(bContext *C, ARegion *ar, void *UNUSED(arg))
{
	...
	int label_delta = 0;
	int indev_width;
	char indev_buf[128] = "\0";
	
	BLI_snprintf(indev_buf, sizeof(indev_buf), "Indev build");

	BLF_size(style->widgetlabel.uifont_id, style->widgetlabel.points, U.pixelsize * U.dpi);
	indev_width = (int)BLF_width(style->widgetlabel.uifont_id, indev_buf, sizeof(indev_buf)) + U.widget_unit;
...
//what the fuck does second shit do?
#ifdef WITH_BUILDINFO
	uiDefBut(block, UI_BTYPE_LABEL, 0, indev_buf, U.pixelsize * 494 - indev_width, U.pixelsize * 270, indev_width, UI_UNIT_Y, NULL, 0, 0, 0, 0, NULL);
#endif  /* WITH_BUILDINFO */
