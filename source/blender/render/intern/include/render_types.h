...
struct Render {
	...
	ThreadCondition tile_cond;       // For future persistent threads
	int next_tile_index;             // Next tile to render (atomic with mutex)
	int max_threads;                 // Number of threads to use
	int use_threading;               // Flag to enable/disable threading
	int active_threads;              // Currently running threads
	void *thread_data;               // Array of RenderThreadData
};

/* Thread data for parallel tile rendering */
